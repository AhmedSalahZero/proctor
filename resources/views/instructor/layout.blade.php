...
<head>
	...
	.margin-for-table-name{
		margin-left:-50px !important;
	}
	  @media (min-width: 992px)
{
	.modal-lg.modal-lg-custom-width, .modal-xl.modal-lg-custom-width{
		max-width:910px
	}
}
	.w-77{
...
<body class="body-bg" style="background-image:url('{{ getMainLoginBackgroundColor() }}')" data-token="{{ csrf_token() }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (calendarEl) {
                let calendarEvents = @json(isset($calendarEvents) ? $calendarEvents : []);
