...
<head>
    ...
    <style type="text/css" id="bf765179-05fa-4725-a46c-6b4627eb1ee7">
        .da570a26-4e6f-4512-80f7-84d2898686d8 {
        ...
        .f320477e-cc4c-4304-931d-c0245645aac4 .ssh-close {
            position: absolute;
            left: -8px;
            top: -8px;
            width: 16px;
            ...
            box-shadow: none;
            animation-name: a39bd928-de14-41fc-b09e-218157634468;
        }

        .f320477e-cc4c-4304-931d-c0245645aac4 .ssh-close:hover,
        .f320477e-cc4c-4304-931d-c0245645aac4 .ssh-close:focus {
        ...
        @media print {
            .f320477e-cc4c-4304-931d-c0245645aac4 {
...
<body id="exam_body" data-user_exam_id="{{$user_exam_id}}" data-user_token="{{csrf_token()}}" style="background: url(http://wellsharpin.com/assets/img/aaa.jpg); padding-left: 20px; padding-right: 20px; overflow: hidden;">
    ...
    <form onsubmit="return confirm1();" action="{{route('front.logout')}}" {{--      method="post"--}} method="GET">
                ...
                <div class="" style="width: 100%; border-radius: 12px;height: 103px;  background-color: rgb(236, 236, 236);border-bottom: 2px solid #9e9e9e">
                    ...
                    <div class="col-md-6  text-right" style="padding-left: 123px; float: right;direction: rtl;">
                        ...
                        <p class="surve" style="margin-bottom: 0px;">
                            <b class="control" style="white-space:nowrap"> {{Auth('students')->user()->Full_Name}} </b> <br>
                            <!-- <b class="time time-remaning on" data-alert=""> 03:30:00 Remaining (0/61 Answered) </b>  -->
                        </p>
                        <div class="time-remaning on" data-alert="" style="direction: ltr;"> <span id="rem_time">
                                {{$remaining_time}}
                                {{-- 00:00:05--}}
                    ...
                    <div class="container working-test" style="width: 100%;" data-question="" data-type="" data-num="">
                        ...
                        <div class="question-text" style="border:0px;">
                            ...
                            <div class="answers-holder" style="font-size: 12px;">
                                ...
                                @foreach($question->answers as $Answer)
                                <label>
                                    <input class="{{$question->ID}}" data-answernum="0" onclick="save_answer( '{{Request()->root().'/'}}','{{$exam->id}}','{{$question->ID}}','{{$Answer->ID}}')" type="radio" name="answer[{{$question->ID}}][]" value="{{$answer->ID}}" @foreach (getCurrentAnsweredQuestion($user_exam_id) as $userAnswer) @if($userAnswer->Answer == $Answer->ID)
                                    checked
                                    @endif
                                    @endforeach
