...
<head>
    ...
    <style type="text/css" id="cd772400-1db7-4223-9ba0-1e159fd26268">
        .d9a4ae51-9c64-45b0-87f7-4ed8cd67088a {
        ...
        .b0c667a6-5001-41d3-8e0f-258a05c8ae68 .ssh-close {
            position: absolute;
            left: -8px;
            top: -8px;
            width: 16px;
            ...
            box-shadow: none;
            animation-name: cfdb7acb-6ae1-4f4b-ad96-5e120556ab13;
        }

        .b0c667a6-5001-41d3-8e0f-258a05c8ae68 .ssh-close:hover,
        .b0c667a6-5001-41d3-8e0f-258a05c8ae68 .ssh-close:focus {
        ...
        @media print {
            .b0c667a6-5001-41d3-8e0f-258a05c8ae68 {
...
<body>
    ...
    $certification = $student->certifications->last()??null;
    @endphp --}}
    ...
    padding-top: 20px;">
                        ...
                        <a href="{{route('download.single.certification',[$certification->id ??0])}}" class=" @if(!isset($ceritication->id)) disabled-link @endif text-center cursor-pointer sm-btn  text-white text-capitalize border-0   btn btn-primary rounded mb-1">download Certification</a>
                        <a href="{{route('download.single.front.certification',[$certification->id ?? 0])}}" class="@if(!isset($ceritication->id)) disabled-link @endif  sm-btn text-white text-capitalize border-0  btn btn-primary rounded mr-1">
                            <i class="fas fa-image text-white fa-lg fs-sm cursor-pointer small-fs"></i>
                            <span class="text-capitalize text-white ">front</span>
                        </a>

                        <a href="{{route('download.single.back.certification',[$certification->id ?? 0])}}" class=" @if(!isset($ceritication->id)) disabled-link @endif  sm-btn text-white text-capitalize border-0 btn btn-primary rounded">
                            <i class="fas fa-image text-white fa-lg fs-sm cursor-pointer small-fs"></i>
                    ...
                    <div class="modal-footer" style="border-top: none;margin-top: 15px;">
                        <a href="{{route('users.logout')}}" class="col-md-2 col-md-offset-5">
                            <div id="startExamBtn" class="col-md-offset-3" style="font-size:15px; margin-top:0px; /*margin-left:15px;*/ margin-bottom:15px;background-color:green;padding: 6px 11px; font-weight: 600; border-radius: 7px; display: inline-block; color: white; cursor: pointer;width: 96px;">Exit Exam</div>
                        </a>

                    </div>

                    <a href="http://wellsharpin.com/site/home/pages/servey" class="col-md-2 col-md-offset-5">
                    </a>
                </div>

                <a href="{{route('survey')}}" class="col-md-2 col-md-offset-5">

                </a>
        </div><a href="{{route('survey')}}" class="col-md-2 col-md-offset-5">

        </a>
        </form>
    </div><a href="http://wellsharpin.com/site/home/pages/servey" class="col-md-2 col-md-offset-5">
    </a>
    </div><a href="http://wellsharpin.com/site/home/pages/servey" class="col-md-2 col-md-offset-5">
