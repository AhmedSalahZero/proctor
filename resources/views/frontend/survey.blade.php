...
<!DOCTYPE html>
<!-- saved from url=(0046)http://wellsharpin.com/site/Home/pages/servey -->
    ...
    <div class="container start-exam" style=" width: 100%; border-radius: 10px; overflow: hidden; box-shadow: rgba(0, 0, 0, 0.6) 0px 0px 15px; margin-top: 10px;padding-left: 0px; padding-right: 0px;border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;">
        ...
        <div class="col-md-2" style="width: 15%;padding-right: 0px;padding-left: 0px;">
            <div class="list-group">
                ...
                <a href="{{route('survey')}}" class="list-group-item " style="border-radius: 0px; background-color: #eaeaea;border-color: #00000069; border-bottom-color: #00000069; border-top-color: #00000069;background-color: #e5241f;color: #ffff;"><b>2</b> servey</a>
                <a href="{{route('start.exam')}}" class="list-group-item disabled " style="border-radius: 0px; background-color: #eaeaea;border-color: #00000069; border-bottom-color: #00000069; border-top-color: #00000069;color: black;"><b>3</b> Start Exam</a>
            </div>
        </div>
                            ...
                            <div style="width:90%; /*min-width:740px;*/ font-family: &#39;Open Sans&#39;;color: #1A1A1A;">
                                <div style="font-size: 14px;color:#1A1A1A; margin-bottom: 14px; text-align:left; padding-top:10px">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select>
                                                    ...
                                                    <option>Assistant Driller </option>
                                                    <option>Tool pusher</option>
                                                    <option>Night Tool pusher</option>


                                                    <option>Drilling Supervisor</option>
                                                    <option>Drilling Engineer </option>
                                                    <option>Rig Manager</option>
                                                    <option>Superintendent </option>

                                                    <option>Rigsite Supervisor </option>
                                                    <option>Coiled Tubing specialist  </option>
                                                    <option>Wire Line Specialist </option>
                                                   
                                                    <option>Workover Specialist </option>
                                                   
                                                    <option>Snubing Specialist </option>
                                                    <option>Oil and Gas operator  </option>
                                        ...
                                        <tr><td>Would you recommend this training provider to your work colleague?</td>
                                            <td>
                                                <select>
                                                    <option>Yes</option>
                                                    <option>No </option>
                                        ...
                                        <tr><td>Please rate the classroom facilities?</td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                        ...
                                        <tr><td>What is the name of the person who taught your class? </td>
                                            <td>
                                                <input type="text" name="type">
                                            </td>
                                        </tr>
                                        <tr><td>How do you rate the instructor overall? </td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How do you rate the instructor's knowledge of the subject matter? </td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How do you rate the instructor's effort to ensure the trainees learned the martial?</td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How do you rate the instructor's preparation?</td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How do you rate your instructor's openness to questions from trainees?</td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How do you rate the course martial (handouts, presentations, visual aids?</td>
                                            <td>
                                                <select>
                                                    <option>Good</option>
                                                    <option>Average </option>
                                        ...
                                        <tr><td>How many simulators were there available for trainees to use during the course?</td>
                                            <td>
                                                <select>
                                                    <option>1 Simulator</option>
                                                    <option>2 Simulator </option>
                                                    <option>Other</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr><td>How much total time did you get to spend controlling the simulator?</td>
                                            <td>
                                                <select>
                                                    <option>0 munites</option>
                                                    <option>15 munites </option>
                                                    <option>30 munites</option>
                                                    <option>1 Hour</option>
                                                    <option>2 Hours</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr><td>Did you receive the practical assessment on either a simulator or live well?</td>
                                            <td>
                                                <select>
                                                    <option>Yes</option>
                                                    <option>No </option>
                                        ...
                                        <tr><td>How many trainees were allowed to use each simulator at the same time (i.e. how many people were in your simulator group?</td>
                                            <td>
                                                <select>
                                                    <option>1-4 Trainees</option>
                                                    <option>4-6 Trainees </option>
                                        ...
                                        <tr><td>Approximately how much time was devoted to your practical assessment?</td>
                                            <td>
                                                <select>
                                                    <option>15 munites</option>
                                                    <option>1 Hour</option>
                                        ...
                                        <tr><td>When you did your drillers practical assessments were you the only person being assessed on the simulator? (Please do not count other people being assessed on another simulator)</td>
                                            <td>
                                                <select>
                                                    <option>Yes</option>
                                                    <option>No </option>
                                        ...
                                        <tr><td>Did you find your simulator adequate for all of the practical exercise?</td>
                                            <td>
                                                <select>
                                                    <option>Yes</option>
                                                    <option>No </option>
                                        ...
                                        <tr><td>Is there a proctor (invigilator) present to administrator the final test?</td>
                                            <td>
                                                <select>
                                                    <option>Yes</option>
                                                    <option>No </option>
...
<script>var BASE='http://wellsharpin.com/';</script>
