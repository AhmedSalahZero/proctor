                ...
                <form class="kt-form kt-form--label-right" method="post" action="{{$route}}">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="class_id" class="form-control @error('class_id') is-invalid @enderror " value="{{$class_id}}" placeholder="Enter Class Id" required>
                            <span class="form-text text-muted">Please Enter Class Id</span>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-12 margin_bottom_class ">
                            <div class="section_permission_name">Assign Certification</div>



                            <span class="kt-switch kt-switch--sm">
                                <label>
                                    <input style="display: none" type="checkbox" id="has_certification" name="has_certification" @if(isset($exam) && $exam->has_certification) checked @endif>
                                    <span></span>
                                </label>
                            </span>
...
<script>
    $(document).on('change', '#has_certification', function() {
        let checked = this.checked;
        if (checked) {
            $('#has_certification_id').fadeIn(300)
            $('#has_certification_id').find('input,select').attr('required', true).prop('disabled', false)
        } else {
            $('#has_certification_id').fadeOut(300)
            $('#has_certification_id').find('input,select').removeAttr('required').prop('disabled', true)

        }
    })
    $('#has_certification').trigger('change')
