                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
							...
							<div class="col-lg-6">
                                ...
                                <input type="text" name="Full_Name" class="form-control @error('Full_Name') is-invalid @enderror " value="{{$Full_Name}}" placeholder="Enter User First Name" required>
                                <span class="form-text text-muted">Please Enter User First Name</span>
                            </div>

                            <div class="col-lg-6">
                                <label>Last Name:</label>
                                <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror " value="{{$last_name}}" placeholder="Enter User Last Name" >
                            ...
                            <div class="col-lg-6 ">
                                <label>Address:</label>
                                <textarea rows="1" type="text" name="address" class="form-control @error('address') is-invalid @enderror " placeholder="Enter Exam Address">{{ old('address') ?: (isset($certification) ? $certification->address : '')}}
                                </textarea>
                            </div>
                    ...
                    <div class="col-12 ">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 ">
                                ...
                                <textarea rows="5" type="text" name="description" class="form-control @error('description') is-invalid @enderror " placeholder="Enter Certification Description" required>{{ old('description') ?: (isset($certification) ? $certification->description : 
