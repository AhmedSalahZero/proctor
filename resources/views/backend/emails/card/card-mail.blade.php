...
{{--<div class="gap" style="page-break-before: always;"></div>--}}

<div class="second-card" style="page-break-before: always;">
    <div class="second-card-logo">
        <div class="second-container">
            @if(isset($public_path))
                <img src="{{public_path('frontend/new/images/iadc_log.png')}}" class="lgoo-img">
            @else
    ...
    <div class="second-card-content">
        <div class="second-container flex-container">
            ...
            @if(isset($public_path))
                <img class="main-content-img" src="{{public_path('frontend/new/images/user.jpg')}}">
            @else
                <img class="main-content-img" src="{{asset('frontend/new/images/user.jpg')}}">
