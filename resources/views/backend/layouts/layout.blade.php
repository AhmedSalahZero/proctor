                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            {{--@can('viewSectionHeader',['Products','Categories'])--}}
                            {{-- <li class="kt-menu__section ">--}}
                            {{-- <h4 class="kt-menu__section-text">@lang('lang.Products')</h4>--}}
                            {{-- <i class="kt-menu__section-icon flaticon-more-v2"></i>--}}
                            {{-- </li>--}}
                            {{--@endcan--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">--}}
                            {{-- @can('ReadOrCreate','Categories')--}}
                            ...
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Categories')</span><i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
                            {{-- </a>--}}
                            {{-- @endcan--}}
                            ...
                            {{-- @can('access',['read','Categories'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('categories.index')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.View All')</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- @can('access',['create','Categories'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('categories.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.Create')</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- </ul>--}}
                            {{-- </div>--}}
                            {{-- </li>--}}
...
{{-- @dd() --}}
                                @if((Auth('students')->user() && Auth('students')->user()->isAdmin()) || Auth('admins')->check() )
                            <li class="kt-menu__section ">
                                <h4 class="kt-menu__section-text">{{ __('Manage Users') }}</h4>
                                <i class="kt-menu__section-icon flaticon-more-v2"></i>
                            </li>

                            <li class="kt-menu__item @if(request()->route()->named('users'))  kt-menu__item--active @endif" aria-haspopup="true">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('certifications.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-certificate"></i></span><span class="kt-menu__link-text">{{ __('Certifications') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('certifications.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('certifications.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Certifications') }}</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item @if(Route::is('certifications.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('certifications.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create Certification') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Students Routes -->
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('students.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-user-graduate"></i></span><span class="kt-menu__link-text">{{ __('Users') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('students.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('students.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Users') }}</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item @if(Route::is('students.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('students.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create User') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="kt-menu__item @if(request()->route()->named('students-scores'))  kt-menu__item--active @endif" aria-haspopup="true">
                                <a href="{{route('students-scores')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <i class="fas fa-chart-line"></i>
                                    </span>
                                    <span class="kt-menu__link-text">{{ __('Users Results') }} </span>
                                </a>
                            </li>
                            ...
                            <!-- Exams Routes -->
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('exams.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-copy"></i></span><span class="kt-menu__link-text">{{ __('Exams') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('exams.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('exams.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Exams') }}</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item @if(Route::is('exams.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('exams.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create Exam') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="kt-menu__item @if(request()->route()->named('current.exams'))  kt-menu__item--active @endif" aria-haspopup="true">
                                <a href="{{route('current.exams')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <i class="fas fa-chart-line"></i>
                                    </span>
                                    <span class="kt-menu__link-text">{{ __('Current Exams') }} </span>
                                </a>
                            </li>



                                <li class="kt-menu__item @if(request()->route()->named('instructor.logs'))  kt-menu__item--active @endif" aria-haspopup="true">
                                <a href="{{route('instructor.logs')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <i class="fas fa-book"></i>
                                    </span>
                                    <span class="kt-menu__link-text">{{ __('Instructor Logs') }} </span>
                                </a>
                            </li>
                            ...
                            <!-- Questions Routes -->
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('questions.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-question"></i></span><span class="kt-menu__link-text">{{ __('Questions') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('questions.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('questions.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Questions') }}</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item @if(Route::is('questions.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('questions.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create Question') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Subjects Routes -->
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('courses.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-list-ul"></i></span><span class="kt-menu__link-text">{{ __('Subjects') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('courses.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('courses.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Subjects') }}</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item @if(Route::is('courses.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('courses.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create Subject') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            @elseif(Auth('students')->user()->isProctor())

                                
                            <!-- Students Routes -->
                            <li class="kt-menu__item  kt-menu__item--submenu @if(Route::is('students.*')) kt-menu__item--active kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <i class="fas fa-user-graduate"></i></span><span class="kt-menu__link-text">{{ __('Proctor') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item @if(Route::is('proctors.index')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('proctors.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('View Page') }}</span>
                                            </a>
                                        </li>
                                        {{-- <li class="kt-menu__item @if(Route::is('students.create')) kt-menu__item--active @endif" aria-haspopup="true">
                                            <a href="{{ route('students.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span> </i>
                                                <span class="kt-menu__link-text">{{ __('Create Student') }}</span>
                                            </a>
                                        </li> --}}
                                    </ul>
                                </div>
                            ...
                            {{-- <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" id="Combined-Shape" fill="#000000" />--}}
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Accounts')</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>--}}
                            {{-- <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>--}}
                            {{-- <ul class="kt-menu__subnav">--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">@lang('lang.Accounts')</span></span></li>--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('accounts.index')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.View All')</span></a></li>--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('accounts.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.Create')</span></a></li>--}}
                            {{-- </ul>--}}
                            {{-- </div>--}}
                            {{-- </li>--}}


                            {{-- @can('viewSectionHeader',['Rules','Permissions','rules-permissions'])--}}
                            {{-- <li class="kt-menu__section ">--}}
                            {{-- <h4 class="kt-menu__section-text">Rules & Permissions</h4>--}}
                            {{-- <i class="kt-menu__section-icon flaticon-more-v2"></i>--}}
                            {{-- </li>--}}

                            {{-- @endcan--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">--}}
                            {{-- @can('ReadOrCreate','Rules')--}}
                            {{-- <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
                            {{-- <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
                            {{-- <rect id="bound" x="0" y="0" width="24" height="24" />--}}
                            {{-- <path d="M2.56066017,10.6819805 L4.68198052,8.56066017 C5.26776695,7.97487373 6.21751442,7.97487373 6.80330086,8.56066017 L8.9246212,10.6819805 C9.51040764,11.267767 9.51040764,12.2175144 8.9246212,12.8033009 L6.80330086,14.9246212 C6.21751442,15.5104076 5.26776695,15.5104076 4.68198052,14.9246212 L2.56066017,12.8033009 C1.97487373,12.2175144 1.97487373,11.267767 2.56066017,10.6819805 Z M14.5606602,10.6819805 L16.6819805,8.56066017 C17.267767,7.97487373 18.2175144,7.97487373 18.8033009,8.56066017 L20.9246212,10.6819805 C21.5104076,11.267767 21.5104076,12.2175144 20.9246212,12.8033009 L18.8033009,14.9246212 C18.2175144,15.5104076 17.267767,15.5104076 16.6819805,14.9246212 L14.5606602,12.8033009 C13.9748737,12.2175144 13.9748737,11.267767 14.5606602,10.6819805 Z" id="Combined-Shape" fill="#000000" opacity="0.3" />--}}
                            {{-- <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" id="Combined-Shape" fill="#000000" />--}}
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Rules')</span><i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
                            {{-- </a>--}}
                            {{-- @endcan--}}
                            {{-- <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>--}}
                            {{-- <ul class="kt-menu__subnav">--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Rules</span></span></li>--}}
                            {{-- @can('access',['read','Rules'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('rules.index')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View All</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- @can('access',['create','Rules'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('rules.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Create</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- </ul>--}}
                            {{-- </div>--}}
                            {{-- </li>--}}
                            ...
                            {{-- <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" id="Combined-Shape" fill="#000000" />--}}
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Permissions')</span><i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
                            {{-- </a>--}}
                            {{-- @endcan--}}
                            {{-- <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>--}}
                            {{-- <ul class="kt-menu__subnav">--}}

                            {{-- <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">@lang('lang.Permissions')</span></span></li>--}}
                            {{-- @can('access',['read','Permissions'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{\App\Models\Permission::index()}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View All</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- @can('access',['create','Permissions'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('permissions.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Create</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- </ul>--}}
                            {{-- </div>--}}
                            {{-- </li>--}}
                            ...
                            {{-- <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">--}}
                            {{-- @can('ReadOrCreate','rules-permissions')--}}
                            {{-- <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
                            {{-- <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
                            {{-- <rect id="bound" x="0" y="0" width="24" height="24" />--}}
                            {{-- <path d="M2.56066017,10.6819805 L4.68198052,8.56066017 C5.26776695,7.97487373 6.21751442,7.97487373 6.80330086,8.56066017 L8.9246212,10.6819805 C9.51040764,11.267767 9.51040764,12.2175144 8.9246212,12.8033009 L6.80330086,14.9246212 C6.21751442,15.5104076 5.26776695,15.5104076 4.68198052,14.9246212 L2.56066017,12.8033009 C1.97487373,12.2175144 1.97487373,11.267767 2.56066017,10.6819805 Z M14.5606602,10.6819805 L16.6819805,8.56066017 C17.267767,7.97487373 18.2175144,7.97487373 18.8033009,8.56066017 L20.9246212,10.6819805 C21.5104076,11.267767 21.5104076,12.2175144 20.9246212,12.8033009 L18.8033009,14.9246212 C18.2175144,15.5104076 17.267767,15.5104076 16.6819805,14.9246212 L14.5606602,12.8033009 C13.9748737,12.2175144 13.9748737,11.267767 14.5606602,10.6819805 Z" id="Combined-Shape" fill="#000000" opacity="0.3" />--}}
                            {{-- <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" id="Combined-Shape" fill="#000000" />--}}
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Rules & Permissions')</span><i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
                            {{-- </a>--}}
                            {{-- @endcan--}}
                            {{-- <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>--}}
                            {{-- <ul class="kt-menu__subnav">--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">@lang('lang.Rules & Permissions')</span></span></li>--}}
                            {{-- @can('access',['read','rules-permissions'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('sections.permission')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Change Permissions</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- --}}{{----}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('permissions.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Create</span></a></li>--}}
                            {{-- </ul>--}}
                            ...
                            {{-- @can('viewSectionHeader',['social-media'])--}}
                            {{-- <li class="kt-menu__section ">--}}
                            {{-- <h4 class="kt-menu__section-text">@lang('lang.Media')</h4>--}}
                            {{-- <i class="kt-menu__section-icon flaticon-more-v2"></i>--}}
                            {{-- </li>--}}

                            {{-- @endcan--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">--}}
                            {{-- @can('ReadOrCreate','social-media')--}}
                            {{-- <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
                            {{-- <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
                            {{-- <rect id="bound" x="0" y="0" width="24" height="24" />--}}
                            {{-- <path d="M2.56066017,10.6819805 L4.68198052,8.56066017 C5.26776695,7.97487373 6.21751442,7.97487373 6.80330086,8.56066017 L8.9246212,10.6819805 C9.51040764,11.267767 9.51040764,12.2175144 8.9246212,12.8033009 L6.80330086,14.9246212 C6.21751442,15.5104076 5.26776695,15.5104076 4.68198052,14.9246212 L2.56066017,12.8033009 C1.97487373,12.2175144 1.97487373,11.267767 2.56066017,10.6819805 Z M14.5606602,10.6819805 L16.6819805,8.56066017 C17.267767,7.97487373 18.2175144,7.97487373 18.8033009,8.56066017 L20.9246212,10.6819805 C21.5104076,11.267767 21.5104076,12.2175144 20.9246212,12.8033009 L18.8033009,14.9246212 C18.2175144,15.5104076 17.267767,15.5104076 16.6819805,14.9246212 L14.5606602,12.8033009 C13.9748737,12.2175144 13.9748737,11.267767 14.5606602,10.6819805 Z" id="Combined-Shape" fill="#000000" opacity="0.3" />--}}
                            {{-- <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" id="Combined-Shape" fill="#000000" />--}}
                            {{-- </g>--}}
                            {{-- </svg></span><span class="kt-menu__link-text">@lang('lang.Social Media')</span><i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
                            {{-- </a>--}}
                            {{-- @endcan--}}
                            ...
                            {{-- <ul class="kt-menu__subnav">--}}
                            {{-- <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Rules</span></span></li>--}}
                            {{-- @can('access',['read','social-media'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('social-media.index')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.View All')</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- @can('access',['create','social-media'])--}}
                            {{-- <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('social-media.create')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">@lang('lang.Create')</span></a></li>--}}
                            {{-- @endcan--}}
                            {{-- </ul>--}}
                            {{-- </div>--}}
                            {{-- </li>--}}
            ...
            -->
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                                <form>
                                    ...
                                    <!--begin: Head -->
                                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url({{asset('backend/assets/media/misc/bg-1.jpg')}})">
                        ...
                        <div class="kt-header__topbar-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                                <form>
                                    ...
                                    <!-- begin:: Mycart -->
                                    <div class="kt-mycart">
                                        <div class="kt-mycart__head kt-head" style="background-image: url({{asset('backend/assets/media/misc/bg-1.jpg')}});">
                                            ...
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="{{asset('backend/assets/media/products/product9.jpg')}}" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="{{asset('backend/assets/media/products/product13.jpg')}}" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="{{asset('backend/assets/media/products/product16.jpg')}}" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="{{asset('backend/assets/media/products/product15.jpg')}}" title="" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                <span class="kt-header__topbar-icon">
                                    <img class="" src="{{asset('backend/assets/media/flags/020-flag.svg')}}" alt="" />
                                </span>
                            </div>
                                ...
                                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                    <li class="kt-nav__item kt-nav__item--active">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="{{asset('backend/assets/media/flags/020-flag.svg')}}" alt="" /></span>
                                            <span class="kt-nav__link-text">English</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="{{asset('backend/assets/media/flags/016-spain.svg')}}" alt="" /></span>
                                            <span class="kt-nav__link-text">Spanish</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="{{asset('backend/assets/media/flags/017-germany.svg')}}" alt="" /></span>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                                <div class="kt-header__topbar-user">
                                    ...
                                    <span class="kt-header__topbar-username kt-hidden-mobile">{{getCurrentAuthName()}}</span>
        ...
        <div class="kt-demo-panel__body">
            <div class="kt-demo-panel__item kt-demo-panel__item--active">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo1.jpg')}}" alt="" />
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo2.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo3.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo4.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo5.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo6.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo7.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo8.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo9.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo10.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo11.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo12.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
                        <a href="backend/demo12/index.html" class="btn btn-brand btn-elevate " target="_blank">Preview</a>
                    </div>
                </div>
            </div>
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo13.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
            ...
            <div class="kt-demo-panel__item ">
                ...
                <div class="kt-demo-panel__item-preview">
                    <img src="{{asset('backend/assets/media/demos/preview/demo14.jpg')}}" alt="" />
                    <div class="kt-demo-panel__item-preview-overlay">
                        <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                    </div>
                </div>
