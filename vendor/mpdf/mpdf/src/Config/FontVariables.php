...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'backupSubsFont' => ['arialmt', 'freesans', 'sun-exta'],
			...
			'fontdata' => [
				"arialmt" => [
					'R' => public_path('storage\fonts\arialmt.ttf'),
				...
				"dejavusansmono" => [
					'R' => public_path('storage\fonts\arialmt.tff'),
			...
			'sans_fonts' => ['ARIALMTq', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
			...
			'serif_fonts' => ['arialmt', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
