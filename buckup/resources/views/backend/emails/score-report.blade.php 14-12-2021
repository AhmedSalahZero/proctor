...
{{--                12:00 Am--}}
                {{  \Carbon\Carbon::make($student->exams()->get()->last()->pivot->Finished_At)->format('M d , Y g:i A')}}
                <br>
        ...
        <table style="width:100%">
            <tbody class="tbody_tbody">
                ...
                <tr class="tr_tr">
                    ...
                    <td class="td_td2">{{  \Carbon\Carbon::make($student->exams()->get()->last()->pivot->Finished_At)->format('M d , Y g:i A') }}</td>
                </tr>
                <tr class="tr_tr">
