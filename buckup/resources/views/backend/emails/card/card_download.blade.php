...
{{--                        <div class="background_image_div" style="height: 110px;width: 70px;background-repeat: no-repeat;background-image: url({{public_path('storage/'.$certification->user->image)}});background-size: contain" ></div>--}}
                    </td>
                </tr>
