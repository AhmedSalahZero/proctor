...
@section('page_center_link',route('courses.index'))
@section('page_right',('Subjects'))
@section('page_right_link',route('courses.index'))
...
{{--                                                <i class="kt-nav__link-icon la la-Courses"></i>--}}
...
{{--                            </div>--}}
{{--                            &nbsp;--}}
                            <a href="{{route('courses.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                              ...
                              <tr >
                                  ...
                                  <td>
                                      <span style="overflow: visible; position: relative; width: 110px;">
                                          <a  title="Edit details" href="{{route('courses.edit',$course->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" type="button"  >
                                              <i class="la la-edit"></i>
                                          </a>
                                          @unless($course->exam)
                                          <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="modal" data-target="#edit_course_{{$course->id}}_model">
                                            ...
                                            @include('backend.partials.confirm_modal',[
                                                                                        ...
                                                                                        'target'=>"edit_course_".$course->id."_model" ,
...
@include('backend.partials.paginator',['model'=>$courses])
...
{{--    <script>--}}
{{--        const courseTypesLinks  = document.getElementsByClassName('filter_by_link');--}}
{{--        Array.from(courseTypesLinks).forEach(function(courseTypeLink){--}}
{{--            courseTypeLink.addEventListener('click',function(event){--}}
