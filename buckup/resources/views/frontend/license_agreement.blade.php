...
<div class="test-page">
    <div class="container start-exam" style="background-color: #fff; width: 100%; height: 100%; border-radius: 10px; overflow: hidden; box-shadow: rgba(0, 0, 0, 0.6) 0px 0px 15px; margin-top: 10px;padding-left: 25px; padding-right: 25px;border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;">
        <div class="col-md-12" style="border-bottom: 2px solid #AC041B !important; padding-top: 18px; padding-bottom: 18px;">
                ...
                <p>
                    <b>
                        @if(Auth()->user('students'))
                            <?php echo Auth()->user('students')->Full_Name ?>
        ...
        <div class="col-md-12" style="margin-top: 16px;     box-shadow: 11px 0px 9px 0px rgba(50, 50, 50, 0.49); border-top-right-radius: 10px; border-top-left-radius: 10px; padding-left: 0px; padding-right: 0px;     height: 650px;margin-bottom: 10px; ">
            <div class="col-md-12 text-center" style="background-color: #4E4D4F;font-size: 14px; font-weight: bold;color: white;padding-top: 1px; padding-bottom: 1px; border-top-right-radius: 10px; border-top-left-radius: 10px;"> License Agreement</div>
            <div class="col-md-12" style="padding-right: 0px; padding-left: 0px;">
                <div class="sectionContent col-md-12" style="background-color: #FFF;box-shadow: 2px 1px 9px rgba(237, 237, 237, 0.42), 0px 0px 40px rgba(196, 196, 196, 0.5) inset;border-bottom: 2px solid gray; border-right: 1px solid lightgray; border-left: 1px solid lightgray; box-sizing: border-box; height: 600px;">
                    <center>
                        <div style=" font-family: &#39;Open Sans&#39;;color: #1A1A1A;">
                            <div style="font-size: 14px;color:#1A1A1A; margin-bottom: 14px; text-align:left; padding-top:10px">
                                ...
                                <p style="margin-bottom:0px ">
                                    ...
                                    Please scroll through and read/understand the entire document before accepting.
                                </p>
                        ...
                        <div style="width:90%; /*min-width:740px;*/ font-family: &#39;Open Sans&#39;;color: #1A1A1A;">
                            <div style="font-size: 14px;color:#1A1A1A; margin-bottom: 14px; text-align:left; padding-top:10px">
                                ...
                                <ol style="margin-top:0px;">
                                    <li>	The international association of Drilling contractors (IADC) WellSharp Knowledge Assessment question represent work of IADC –member subject matter experts and other volunteers.<br> 	The IADC WellSharp knowledge Assessment database will generate a unique set of well control question dependent upon the level of the course taken. Stack type and any supplement<br> areas include in s specific course.</li>
                                    <li>All information and material contained within The IADC WellSharp knowledge assessment database is the intellectual property of IADC. This information is intended solely for use
                                        <br> by individuals and their employers to assess such individual’s knowledge. Use of this information for any other purpose. Including development of any commercial product is expressly prohibited.</li>
                                    <li>	IADC WellSharp Knowledge Assessment are intended to test an individual’s Knowledge of well control successful completion of an assessment in not intended to, and does constitute. The competency level of any individual and it is the responsibility of the individual and /or such individual’s employer to assess and determine competency and skill level.</li>
                                    <li>	IADC makes no representation, Warranty, or guarantee is connection with the IADC WellSharp Knowledge Assessment, or any instructors thereof, and hereby expressly disclaims any liability or responsibility for loss or damage of any kind or nature resulting from the use of this product or any instructors thereof.</li>
                                    <li> 	By using IADC WellSharp Knowledge Assessment database and exams, you agree to release. indemnify, defend  and hold harmless  IADC , Its officers , employees and volunteers, against any and claims or causes of action you may have arising out of or in connection with your use of the testing database , exams or other use of the WellSharp Knowledge Assessment.</li>
                                </ol>
                ...
                <hr>
                <div class="col-md-12 text-right" style="background-color: #FFF;box-shadow: 2px 1px 9px rgba(237, 237, 237, 0.42), 0px 0px 40px rgba(196, 196, 196, 0.5) inset;border-bottom: 1px solid gray; border-right: 1px solid lightgray; border-left: 1px solid lightgray; box-sizing: border-box; padding-bottom: 4px; padding-top: 4px;">
                    <a href="{{route('front.logout')}}" style="color: inherit;">
                        <button>Decline</button>
                    </a>
                    <a href="{{route('show.students.instruction')}}" style="color: inherit;">
